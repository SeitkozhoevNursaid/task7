...
from login.tasks import send_activation_code, send_reset_password
...
class RegistrationSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        validated_data.pop('password2')  # TODO
        validated_data.setdefault('last_change_password', timezone.now())
        user = CustomUser.objects.create_user(**validated_data)
        send_activation_code.delay(validated_data['email'], user.activation_code)  # TODO
...
class ConfirmForgotPasswordSerializer(serializers.Serializer):  # TODO: ...
